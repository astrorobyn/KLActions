...
c     ------------------------------------------------------------
     ...
     &     '/Users/robyn/Documents/Research/KLStats/Isochrone/')
      ...
      character*38 posin, velin
      character*41 posout, velout
      parameter(posin='With4MOSTErrors/RedGiants/pos.test.dat')
      parameter(posout='With4MOSTErrors/RedGiants/newpos.test.dat')
      parameter(velin='With4MOSTErrors/RedGiants/vel.test.dat')
      parameter(velout='With4MOSTErrors/RedGiants/newvel.test.dat')

      character*33 obsout
      parameter(obsout='With4MOSTErrors/RedGiants/obs.dat')
...
c     &        s_vr, nb)
         ...
         call error_obs_4MOST(par,spar,spm,svr,vmag)
