...
c     ------------------------------------------------------------
     ...
     &     '/Users/robyn/Documents/Research/KLStats/Isochrone/')
      ...
      character*37 posin, velin
      character*40 posout, velout
      parameter(posin='WithGaiaErrors/RedGiants/pos.test.dat')
      parameter(posout='WithGaiaErrors/RedGiants/newpos.test.dat')
      parameter(velin='WithGaiaErrors/RedGiants/vel.test.dat')
      parameter(velout='WithGaiaErrors/RedGiants/newvel.test.dat')

      character*33 obsout
      parameter(obsout='WithGaiaErrors/RedGiants/obs.dat')
