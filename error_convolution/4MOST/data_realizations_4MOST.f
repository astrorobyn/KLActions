...
c     ------------------------------------------------------------
     ...
     &     '/data2/users/sanderson/Research/KLStats/Isochrone/')
      ...
      character*33 posin, velin
      character*36 posout, velout
      parameter(posin='With4MOSTErrors/MSTO/pos.test.dat')
      parameter(posout='With4MOSTErrors/MSTO/newpos.test.dat')
      parameter(velin='With4MOSTErrors/MSTO/vel.test.dat')
      parameter(velout='With4MOSTErrors/MSTO/newvel.test.dat')

      character*28 obsout
      parameter(obsout='With4MOSTErrors/MSTO/obs.dat')
